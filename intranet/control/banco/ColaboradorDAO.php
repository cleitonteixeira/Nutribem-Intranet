    ...
    if(isset($_POST['Colaborador']) && $_POST['Colaborador']  ==  "Cadastro"):
        ...
        if($_POST['email'] != ""):
            if(!filter_var($_POST['email'], FILTER_VALIDATE_EMAIL)):
                echo "<script>alert('Formato de e-mail incorreto!');window.setTimeout('history.go(-1)', 0);</script>";exit;
            else:
                            ...
                            if($Colaborador):
                                ...
                                if($_POST['dNome1'] == ""):
                                    $SAgencia = utf8_encode(anti_injection($_POST['sAgencia']));
                                        ...
                                        if($ContaS):
                                            if($_POST['banco'] == null):        
                                                echo "<script>alert('Cadastrado com Sucesso!');window.location.href='".BASE."colaborador/Colaborador.php';</script>";
                                            else:
