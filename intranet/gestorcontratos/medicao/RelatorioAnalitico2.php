...
<html>
    ...
    <body>
        <div class="col-xs-12 col-lg-12 col-md-12">
            <h1 class="text-center" style="margin-top: 5% !important;"><img class="text-left" src="../img/IconeRel.png" /><span class="text-center">MEDIÇÃO: <?php echo $ct->Medicao; ?></span></h1>
            <div class="panel panel-default text-justify" style="margin-top: 5% !important;">
                ...
                <div class="panel-body">
                   <div class="col-xs-5 col-md-5 col-lg-5"><p><strong>Nome: </strong><?php echo $Nome; ?></p></div>
                    ...
                    <div class="col-xs-4 col-md-4 col-lg-4"><p><strong>Condição: </strong><?php echo $row->Condicao; ?></p></div>
        ...
        ?>
        <p>Valor Total da medição <strong>R$ <?php echo number_format($total2,2,',','.'); ?></strong>.</p>
