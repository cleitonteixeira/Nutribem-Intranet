...
<div class="container-fluid">
    <div class="row">
        <div class="col-md-12 col-xs-12 col-lg-12 conteudo">
            <h1 class="text-center">ADICIONAR ITENS AO CONTRATO</h1>
            ...
            <form name="Form" role="form" action="<?php echo BASE; ?>control/banco/AlterContratoDAO.php" method="post" enctype="multipart/form-data" class="form-horizontal" data-toggle="validator" id="FormCliente" name="FormCliente">
                <div class="col-xs-12 col-md-12 col-lg-12">
                ...
                <div class="col-xs-12 col-md-12 col-lg-12">
                    <div class="col-xs-12 col-md-12 col-lg-12">
                        <div class="col-xs-offset-1">
                            <div><h4><u>Valores e Eventos da Proposta</u></h4></div>
                            <div class='col-xs-12 col-md-12 col-lg-12'>
                                <div class='col-xs-4 col-sm-4 col-md-4'>
                                    <div class='form-group'>
                                        <label class='control-label col-sm-3' for='Evento1'>Evento:</label>
                                        <div class='col-sm-8'>
                                            <input type='text' name='Evento1' id='Evento1' class='form-control' required >
                                ...
                                <div class='col-xs-4 col-sm-4 col-md-4'>
                                    <div class='form-group'>
                                        <label class='control-label col-sm-2' for='valor1'>Valor:</label>
                                        <div class='col-sm-8'>
                                            <div class='input-group'>
                                                <span class='input-group-addon' id='real'>R$</span>
                                                <input type='text' class='form-control' id='valor1' name='valor1' placeholder='0,00' aria-describedby='real' value='0,00' required />
                                            </div>
                                            <div class="help-block with-errors"></div>
                                        </div>
                                    </div>
                ...
                <div id="botoes" class="col-xs-offset-1 col-xs-11 col-md-offset-1 col-md-11 col-lg-offset-1 col-lg-11">
                    <input type="hidden" name="cont" value="alter" />
                    <button class="btn btn-success" type="submit">Alterar Contrato</button>
                </div>
                <div class="col-xs-12 col-md-12 col-lg-12"> 
                </div>
            </form>
