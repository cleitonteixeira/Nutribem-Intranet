...
$sql = "SELECT ct.idContrato, cd.Nome AS Cliente, cdu.Nome AS Unidade,ct.nContrato AS Contrato, ct.cCusto, ct.pCompra, ct.VigenciaFim FROM contrato ct INNER JOIN contratante co ON co.idContratante = ct.Contratante_idContratante INNER JOIN cadastro cd ON cd.idCadastro = co.Cadastro_idCadastro INNER JOIN unidadefaturamento un ON un.idUnidadeFaturamento = ct.Unidade_idUnidade INNER JOIN cadastro cdu ON cdu.idCadastro = un.Cadastro_idCadastro WHERE ct.Finalizado = 'N' ORDER BY ct.VigenciaFim;";
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-xs-12 col-md-12 col-lg-12">
                    <p>Próximos vencimentos de contratos:</p>
                </div>
                <div class="col-xs-12 col-md-12 col-lg-12">
                    <table class="table table-bordered table-responsive">
                        ...
                        <tbody>
                            ...
                            if($stm->rowCount() > 0){
                                ...
                                foreach($rs as $r){
                                    $data 		= strtotime(date('Y-m-d', strtotime($r->VigenciaFim)));
                            ...
                            <tr class="fd01">
                                ...
                                <td><?php echo utf8_decode(date("d/m/Y", strtotime($r->VigenciaFim))); ?></td>
                                <td><a class="btn btn-primary" href="http://www.nutribemrefeicoescoletivas.com.br/intranet/gestorcontratos/pesquisas/DetalheContrato.php?id=<?php echo $r->idContrato;?>">DETALHE</a></td>
                            </tr>
                            <?php  
                                    }
                                }
                            ...
                            <tr>
                                <td colspan="7">
                                    <p>NÃO EXISTEM CONTRATOS COM VENCIMENTO PARA OS PROXIMOS 60 DIAS.</p>
                                </td>
                            </tr>
                            <?php
                            }
                ...
                <div class="col-xs-12 col-md-12 col-lg-12">
                    <p><span class="fd90_t">█</span> De 90 a 61 dias para o vencimento.</p>
                    <p><span class="fd60_t">█</span> De 60 a 1 dia para o vencimento.</p>
                    <p><span class="fd01_t">█</span> Já se encontra vencido.</p>
                </div>
            </div>
        </div>
    </body>
...
$email->Subject		= 'Gestor de Contratos: VENCIMENTO DE CONTRATO';
...
//$email->AddBCC( 'ti@nutribemrefeicoescoletivas.com.br' , 'Tecnologia - Nutribem Refeições Coletivas' );
