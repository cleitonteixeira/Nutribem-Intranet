                  ...
                  <div class="panel panel-default">
                    ...
                    <div id="collapse-u<?=$rrt->idUnidadeFaturamento;?>" class="panel-collapse collapse">
                        <table class="table table-bordered table-striped table-responsive">
                            ...
                            <tbody>
                        <?php
                        $sql = "SELECT idContrato, Fechamento FROM contrato c WHERE c.Unidade_idUnidade = ? AND c.Finalizado = 'N' ORDER BY nContrato";
                        ...
                        foreach($rest as $r){
                            ...
                            $sql2 = "SELECT * FROM contrato c INNER JOIN contratante cc ON cc.idContratante = c.Contratante_idContratante INNER JOIN cadastro cd ON cd.idCadastro = cc.Cadastro_idCadastro WHERE c.idContrato = ?;";
