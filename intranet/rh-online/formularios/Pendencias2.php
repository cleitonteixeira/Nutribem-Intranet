<?php
    ...
    $sql = "SELECT * FROM pendencias WHERE Unidade_idUnidade IN (SELECT Unidade_idUnidade FROM unidadeuser WHERE Usuario_idUsuario = ?) AND Resultado NOT IN ('Recusada', 'Validada', 'Recusada (Preenchimento Incorreto)') ORDER BY Data DESC;";
