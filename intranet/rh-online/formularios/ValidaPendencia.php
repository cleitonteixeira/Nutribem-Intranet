    ...
    <div class="row">
        <div class="col-md-12 col-xs-12 col-sm-12 conteudo">
            <div class="validacao">
                ...
                case("Ferias"):
                try{
                    $sql = "SELECT ct.Unidade_idUnidade, ctu.Nome AS Unidade, (SELECT cad.CNPJ AS Empresa FROM empresa em INNER  JOIN cadastro cad ON cad.idCadastro = em.Cadastro_idCadastro WHERE em.idEmpresa = un.Empresa_idEmpresa) AS CNPJ,(SELECT cad.Nome AS Empresa FROM empresa em INNER JOIN cadastro cad ON cad.idCadastro = em.Cadastro_idCadastro WHERE em.idEmpresa = un.Empresa_idEmpresa) AS Empresa, u.Nome AS Solicitante, c.Nome AS Imediato, co.CodColaborador, ca.Nome AS Colaborador, f.* FROM usuarios u INNER JOIN ferias f ON f.idFerias = ? INNER JOIN usuarios c ON c.idUsuarios = ? INNER JOIN colaborador co ON co.idColaborador = f.Colaborador_idColaborador INNER JOIN contratacao ct ON ct.idContratacao = co.Contratacao_idContratacao INNER JOIN unidade un ON un.idUnidade = ct.Unidade_idUnidade INNER JOIN cadastro ctu ON ctu.idCadastro = un.Cadastro_idCadastro INNER JOIN cadastro ca ON ca.idCadastro = co.Cadastro_idCadastro WHERE u.idUsuarios = ? LIMIT 1";
                    ...
                    <div class="col-xs-4">
                        <div class="panel panel-primary text-justify">
                            ...
                            <?php
                                    ...
                                    $sql = "SELECT idusuarios FROM usuarios WHERE idUsuarios IN ( SELECT Usuario_idUsuario FROM unidadeuser WHERE Unidade_idUnidade = ?) AND Login <> 'rh.sede01'";
                                    $stm = $conexao->prepare($sql);
                ...
                <div class="col-xs-12">
                    ...
                    <div class="col-xs-4">
                        <div class="panel panel-primary text-justify">
                            ...
                            $sql = "SELECT idusuarios FROM usuarios WHERE idUsuarios IN ( SELECT Usuario_idUsuario FROM unidadeuser WHERE Unidade_idUnidade = ?) AND Login <> 'anderson' AND Login <> 'virgilio' AND Login <> 'rh.sede01'";
                            $stm = $conexao->prepare($sql);
                            $stm->bindParam(1, $res->Unidade_idUnidade);
                            $stm->execute();
                            while($rs = $stm->fetch(PDO::FETCH_OBJ)):
                    ...
                    <div class="col-xs-4">
                        <div class="panel panel-primary text-justify">
                            ...
                            $rh = array(3,16,14,1);
                            $rh1 = "3,16,1,14";
                            $sql = "SELECT vp.*,u.Nome FROM validapendencia vp INNER JOIN usuarios u ON u.idUsuarios = vp.Usuario_idUsuario WHERE vp.Usuario_idUsuario IN (3,16,14,1) AND vp.Pendencia_idPendencia = ?;";
                            $stm = $conexao->prepare($sql);
                            $stm->bindParam(1, $_GET['p']);
                            $stm->execute();
                    ...
                    <div class="panel panel-primary text-left">
                        ...
                        <div class="panel-body">
                            ...
                            <p>
                                ...
                                <strong>Motivo: </strong><?php switch($res->Motivo){
                                        case("aQuadro"):
