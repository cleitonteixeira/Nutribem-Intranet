...
<div class="container-fluid">
    <div class="row">
        <div class="col-md-12 conteudo">
            ...
            <div class="col-xs-12 col-lg-12 col-md-12 text-center"><h1><span class="label label-info">REGISTRO DE EMPREGADO</span></h1></div>
            ...
            <div class="col-xs-12">
                ...
                <div class="tab-content">
                    <div id="Pessoais" class="tab-pane fade in active">
                        ...
                        <div class="col-xs-12 col-md-12 col-lg-12"><h3 class="Colaborador"><strong>Nome:</strong> <?php echo utf8_decode($rs->Nome);?></h3></div>
                        <div class="col-xs-12 col-md-12 col-lg-12"><h4><u>FILIAÇÃO</u></h4></div>
                        ...
                        <div class="col-xs-12 col-md-12 col-lg-12"><h4><u>DOCUMENTAÇÃO</u></h4></div>
                        <div class="col-xs-12 col-md-12 col-lg-12">    
                        ...
                        <div class="col-xs-12 col-md-12 col-lg-12"><h4><u>DADOS COMPLEMENTARES</u></h4></div>
                        <div class="col-xs-12 col-md-12 col-lg-12">
                    ...
                    <div id="Contratacao" class="tab-pane fade">
                        <div class="col-xs-12 col-md-12 col-lg-12"><h4><u>EMPRESA</u></h4></div>
                        <div class="col-xs-12 col-md-12 col-lg-12">
                            <div class="col-sm-8"><p><strong>Empregador:</strong> <?php echo utf8_decode(strtoupper($rs->Empresa));?></p></div>
                            <div class="col-sm-3"><p><strong>CNPJ:</strong> <?php  echo  CNPJ_Padrao($rs->CNPJ); ?></p></div>
                            <div class="col-sm-3"></div>
                            <div class="col-sm-12"><p><strong>Endereço:</strong>
                                <?php
                            ...
                            <div class="col-sm-2"><p><strong>CEP: </strong><?php echo CEP_Padrao($rsEm->CEP); ?> </div>
                        </div>
                        <div class="col-xs-12 col-md-12 col-lg-12"><h4><u>UNIDADE</u></h4></div>
                        <div class="col-xs-12 col-md-12 col-lg-12">
                            <div class="col-sm-6"><p><strong>Unidade:</strong> <?php echo utf8_decode($rs->Unidade);?></p></div>
                            ...
                            <div class="col-sm-2"><p><strong>CEP: </strong><?php echo CEP_Padrao($rsUn->CEP); ?> </div>
                        </div>
                        <div class="col-xs-12 col-md-12 col-lg-12"><h4><u>DADOS CONTRATAÇÃO</u></h4></div>
                        <div class="col-xs-12 col-md-12 col-lg-12">
                            <div class="col-sm-3"><p><strong>CTPS:</strong> <?php echo utf8_decode($rs->CTPS);?></p></div>
                            <div class="col-sm-3"><p><strong>Série CTPS:</strong> <?php echo str_pad($rs->sCTPS,4,0, STR_PAD_LEFT);?></p></div>
                            <div class="col-sm-3"><p><strong>UF CTPS:</strong> <?php echo utf8_decode($rs->UFCTPS);?></p></div>
                            <div class="col-sm-3"><p><strong>Data CTPS:</strong> <?php echo Muda_Data($rs->dCTPS);?></p></div>
                            <div class="col-sm-3"><p><strong>Cargo:</strong> <?php echo utf8_decode($rs->Cargo);?></p></div>
                            <div class="col-sm-3"><p><strong>Função:</strong> <?php echo utf8_decode($rs->Funcao);?></p></div>
                            <div class="col-sm-3"><p><strong>Salário:</strong>  <?php echo "R$ ".number_format($rs->Salario,2,',','.'); ?></p></div>
                            <div class="col-sm-3"><p><strong>ASO:</strong>  <?php echo Muda_Data($rs->dASO); ?></p></div>
                            <div class="col-sm-3"><p><strong>Admissão:</strong>  <?php echo Muda_Data($rs->dAdmissao); ?></p></div>
                            <?php if($rs->dDemissao != ""):?>    
                            <div class="col-sm-3"><p><strong>Demissão:</strong>  <?php echo Muda_Data($rs->dDemissao); ?></p></div>
                            <?php endif;?>
                        </div>
                    </div>
                    <div id="Filhos" class="tab-pane fade">
                        <div class="col-xs-12 col-md-12 col-lg-12"><h4><u>DEPENDENTES</u></h4></div>
                        <?php
                        ...
                        ?>
                        <div class="col-xs-12 col-md-12 col-lg-12 Separa">
                            <div class="col-sm-7"><p><strong>Nome:</strong> <?php echo utf8_decode($fRow->dNome);?></p></div>
                            <div class="col-sm-5"><p><strong>Parentesco:</strong> <?php echo utf8_decode($fRow->Parentesco);?></p></div>
                            <div class="col-sm-6"><p><strong>Nome da Mãe:</strong> <?php echo utf8_decode($fRow->nMae);?></p></div>
                            <div class="col-sm-6"><p><strong>Data de Nascimento:</strong> <?php echo utf8_decode(Muda_Data($fRow->dNascimento));?></p></div>
                            <div class="col-sm-3"><p><strong>Registro:</strong> <?php echo utf8_decode(strtoupper($fRow->Registro));?></p></div>
                            <div class="col-sm-2"><p><strong>Livro:</strong> <?php echo utf8_decode(strtoupper($fRow->Livro));?></p></div>
                            <div class="col-sm-2"><p><strong>Folha:</strong> <?php echo utf8_decode(strtoupper($fRow->Folha));?></p></div>
                            <div class="col-sm-5"><p><strong>DNV:</strong> <?php echo utf8_decode(strtoupper($fRow->DNV));?></p></div>
                            
                            <?php if($fRow->dCPF != "" && $fRow->dCPF != 0):?>
                                <div class="col-sm-4"><p><strong>CPF:</strong> <?php echo utf8_decode(CPF_Padrao(str_pad($fRow->dCPF,11,0, STR_PAD_LEFT)));?></p></div>
                            <?php else: ?>
                                <div class="col-sm-4"><p><strong>CPF:</strong>###.###.###-##</p></div>
                            <?php endif;?>
                        </div>
                        <?php
                            endwhile;
                    ...
                    <div id="Bancarios" class="tab-pane fade">
                        ...
                        ?>
                        <div class="col-xs-12 col-md-12 col-lg-12 Separa">
                            <div class="col-xs-12 col-md-12 col-lg-12"><h4><u>DADOS BANCÁRIOS</u></h4></div>
                    ...
                    <div id="Endereco" class="tab-pane fade">
                        <div class="col-xs-12 col-md-12 col-lg-12"><h4><u>DADOS DE ENDEREÇO</u></h4></div>
                        <div class="col-xs-12 col-md-12 col-lg-12 separa">
                            <div class="col-sm-6"><p><strong>Logradouro: </strong> <?php  echo utf8_decode($rs->Endereco); ?></p></div>
                            <div class="col-sm-3"><p><strong>Nº: </strong> <?php  echo utf8_decode($rs->Numero); ?></p></div>
                            <div class="col-sm-3"><p><strong>Bairro: </strong> <?php  echo utf8_decode($rs->Bairro); ?></p></div>
                            <div class="col-sm-3"><p><strong>Cidade: </strong> <?php  echo utf8_decode($rs->Cidade); ?></p></div>
                            <div class="col-sm-3"><p><strong>UF: </strong> <?php  echo utf8_decode($rs->UF); ?></p></div>
                            <div class="col-sm-3"><p><strong>CEP: </strong> <?php  echo CEP_Padrao($rs->CEP); ?></p></div>
                        </div>
                    </div>
                    <div id="Contato" class="tab-pane fade">
                        <div class="col-xs-12 col-md-12 col-lg-12"><h4><u>DADOS DE CONTATO</u></h4></div>
                        <div class="col-xs-12 col-md-12 col-lg-12 separa">
                        <?php if($rs->Celular != "" && $rs->Celular != 0):?>
                            <div class="col-sm-12"><p><strong>Celular:</strong> <?php echo Cel_Padrao($rs->Celular); ?></p></div>
                        <?php else: ?>
                            <div class="col-sm-12"><p><strong>Celular:</strong> (##) #####-####</p></div>
                        <?php endif; ?>
                        <?php if($rs->Telefone != "" && $rs->Telefone != 0):?>
                            <div class="col-sm-12"><p><strong>Telefone:</strong> <?php echo Tel_Padrao($rs->Telefone); ?></p></div>
                        <?php else: ?>
                            <div class="col-sm-12"><p><strong>Telefone:</strong> (##) ####-####</p></div>
                        <?php endif; ?>
                    
                        <?php if($rs->email != ""):?>
                            <div class="col-sm-12"><p><strong>E-mail:</strong> <?php echo $rs->email; ?></p></div>
                        <?php else: ?>
                            <div class="col-sm-12"><p><strong>E-mail:</strong> * Nenhum Registro *</p></div>
                        <?php endif; ?>
                        </div>
                    </div>
                    <div id="Extras" class="tab-pane fade">
                        <?php $rh = array(1,3,14,15,16); if($rs->dDemissao == null && in_array($_SESSION['idusuarios'],$rh) ){?>
                        <div class="col-xs-6 col-md-6 col-lg-6 form01">
                            <div class=""><h4><u>Promoção</u></h4></div>
                        ...
                        <?php }$rh = array(1,3,14,15,16,17,21); if($rs->dDemissao == null && in_array($_SESSION['idusuarios'],$rh) ){?>
                        <div class="col-xs-6 col-md-6 col-lg-6">
                            <div class=""><u><h4>Demissão</h4></u></div>
                            <form role="form" class="form-horizontal" action="<?php echo BASE."control/banco/ExtrasDAO.php"; ?>" method="post" enctype="multipart/form-data" data-toggle="validator">
                                <div class="form-group">
                                    <label class="col-sm-2 control-label" for="data">Data:</label>
                                    <div class="col-sm-4">
                        ...
                        <div class="col-xs-12 col-md-12 col-lg-12">
                            <div class="col-xs-12 col-md-12 col-lg-12"><h4><u>HISTÓRICO</u></h4></div>
                            <?php
