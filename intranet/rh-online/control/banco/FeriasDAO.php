					...
					<div class="col-xs-12" id="form-ferias">
						<div class="col-xs-12 ferias-t">
							...
							<div class="text-center col-xs-12">
								<p><strong>Empregador: </strong><?php echo utf8_decode($_POST['Empregador']); ?></p>
								<p><strong>CNPJ nº: </strong><?php echo $_POST['cnpj']; ?></p>
							</div>
							<div class="col-xs-12">
								<p><strong>Nome do Funcionário: </strong><?php echo utf8_decode($_POST['Nome']); ?>.</p>
							...
							<div class="text-right col-xs-12">
								<p>________________________, <?php echo utf8_encode(strftime("%d de %B de %Y")); ?>.</p>
							</div>
							<p>&thinsp;</p>
...
try{
	...
	if($_SESSION["idusuarios"] != 1){
        ...
        $email->AddAddress( 'ti@nutribemrefeicoescoletivas.com.br' , 'Cleiton Teixeira' );
        $email->AddCC('rh@nutribemrefeicoescoletivas.com.br', 'RH Nutribem'); // Copia
    }
	$enviado = $email->Send();
