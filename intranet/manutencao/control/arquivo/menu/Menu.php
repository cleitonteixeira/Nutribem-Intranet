        ...
        <div class="container">
            ...
            <div id="navbar" class="collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    ...
                    <?php if($_SESSION['Acesso'] == 4 || $_SESSION['idusuarios'] == 1){?>
                    <li class="dropdown">              
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false">
                    ...
                    <li class="dropdown">              
                        ...
                        <ul class="dropdown-menu" role="menu">
                            <li><a href="<?php echo BASE?>agenda/CadastrarAgenda.php"><i class="fa fa-plus-circle"></i>
                                Cadastrar</a></li>
                            <li class="divider"></li>
                            <li><a href="<?php echo BASE; ?>agenda/Agenda.php"><i class="fa fa-calendar-alt"></i>
                                Verificar</a></li>
                        </ul>
                    </li>
                    <?php }else{ ?>
                    <li><a href="<?php echo BASE; ?>agenda/Agenda.php">Agenda <i class="fafa-calendar-alt"></i></a></li>
                    <?php }?>
                </ul>
