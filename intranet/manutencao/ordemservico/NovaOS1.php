        ...
        $.each(dados, function(i, obj){
            switch(obj.Retorno){
              ...
              case 'Sucesso':
                ...
                $.post('AddEquipamento.inc.php', {LoadItem: 'lItem'}, function (dados1){
                ...
                <form method="post" enctype="multipart/form-data" rel="form" class="form-horizontal" data-toggle="validator">
                  <table class="table table-bordered table-striped table-hover">
                    ...
                    <tbody id="TableEquipamento">
                        <?php
                        $sql = "SELECT c.Nome AS Equipamento, e.*, ce.* FROM equipamento e INNER JOIN cadastro c ON idCadastro = Cadastro_idCadastro INNER JOIN categoriaequipamento ce ON idCategoriaEquipamento = Categoria_idCategoria;";
